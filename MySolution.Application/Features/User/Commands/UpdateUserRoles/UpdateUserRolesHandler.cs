        ...
        UpdateUserRolesResponse>
{
    ...
    public async Task<UpdateUserRolesResponse> Handle(
        UpdateUserRolesCommand request,
        CancellationToken cancellationToken)
    {
        var payload = request.Payload;
        var functionName =
            $"{nameof(UpdateUserRolesHandler)} =>";
        ...
        try
        {
            ...
            var currentUserRoles =
                await _unitOfWork.UserRole
                    .GetByUserIdAsync(payload.UserId);
            ...
            if (roleIdsToAdd.Count > 0)
            {
                ...
                var roles =
                    await _unitOfWork.Role
                        .GetByIdsAsync(roleIdsToAdd);
                var foundRoleIds =
                    roles
                        .Select(x => x.Id)
                        .ToHashSet();
