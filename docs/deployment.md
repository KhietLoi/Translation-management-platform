...
Frontend, API chính, Email API, AI translation có thể có image/pipeline riêng. Migration cần chạy như job có kiểm soát. Các thư mục Domain/Application/Infrastructure là thư viện, không cần container riêng.
...
2. Hoàn thiện Dockerfile cho frontend và AI. Xác nhận dependency/model của AI trước khi đóng image.
