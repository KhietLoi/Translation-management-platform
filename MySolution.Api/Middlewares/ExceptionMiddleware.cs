...
public class ExceptionMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        var message = exception switch
        {
            ...
            FormatException =>
                "The format of an argument is invalid, or when a composite format string is not well formed",
            ...
            KeyNotFoundException =>
                "The key specified for accessing an element in a collection does not match any key in the collection",
            NotSupportedException =>
                "An invoked method is not supported, or when there is an attempt to read, seek, or write to a stream that does not support the invoked functionality",
