           ...
           var projectQuery = _unitOfWork.Project
            ...
            var languages =
                await _unitOfWork.TranslationValue
                    .GetPendingLanguageCountsAsync(request.ProjectId, request.NamespaceId, cancellationToken);

            response.Data = new GetPendingLanguageCountsResult { Languages = languages };
